// Inicialización de colecciones para tiendaDB en MongoDB

// Este script será ejecutado automáticamente por Mongo al iniciar el contenedor
// mediante el mecanismo /docker-entrypoint-initdb.d.
  ...
  validator: {
    $jsonSchema: {
      ...
      properties: {
        ...
        moneda: { enum: ["CRC"], description: "Moneda usada" },
