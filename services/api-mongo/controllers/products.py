...
class ProductsController:
    ...
    @staticmethod
    def get_skus_by_codigos_mongo(codigos_mongo: List[str], db_connection: pyodbc.Connection) -> Dict[str, Any]:
        try:
            ...
            mappings = products_repository.get_skus_by_codigos_mongo(db_connection, codigos_string)
