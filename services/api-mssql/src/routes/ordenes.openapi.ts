...
export const listOrdenesRoute = createRoute({
  ...
  parameters: [
    ...
    },
    {
      ...
      in: 'query',
      required: false,
      schema: { type: 'string', description: 'Partial search by sales channel' },
    },
    {
      name: 'canalExact',
      in: 'query',
    ...
    },
    {
      ...
      in: 'query',
      required: false,
      schema: { type: 'string', description: 'Filter by currency (e.g., USD, EUR)' },
    },
    {
      name: 'fechaDesde',
      in: 'query',
      required: false,
      schema: { type: 'string', format: 'date-time', description: 'Filter orders from this date onwards (ISO 8601)' },
    },
    {
      name: 'fechaHasta',
      in: 'query',
      required: false,
      schema: { type: 'string', format: 'date-time', description: 'Filter orders until this date (ISO 8601)' },
    },
    {
      name: 'totalMin',
      in: 'query',
      required: false,
      schema: { type: 'number', description: 'Minimum order total (>= totalMin)' },
    },
    {
      name: 'totalMax',
      in: 'query',
      required: false,
      schema: { type: 'number', description: 'Maximum order total (<= totalMax)' },
    },
    {
      name: 'totalGt',
      in: 'query',
      required: false,
      schema: { type: 'number', description: 'Orders with total greater than (> totalGt)' },
    },
    {
      name: 'totalLt',
      in: 'query',
      required: false,
      schema: { type: 'number', description: 'Orders with total less than (< totalLt)' },
    },
    {
      name: 'totalEq',
      in: 'query',
      required: false,
      schema: { type: 'number', description: 'Orders with exact total (= totalEq)' },
    },
    {
      name: 'sortBy',
      in: 'query',
      required: false,
      schema: { type: 'string', description: 'Sort field: Fecha, Canal, Moneda, Total, OrdenId' },
    },
    {
      name: 'sortOrder',
      in: 'query',
